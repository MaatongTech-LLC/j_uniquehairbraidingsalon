    ...
    <div class="page-contact-us" style="background-color: #f2f4f6;">
        <div class="container">
            ...
            <div class="contact-form-box px-5" style="max-width: 700px; margin: 0 auto;">
                <div class="container">
                    <form  action="{{ route('forgot-password.post') }}" method="POST" data-toggle="validator" class="wow fadeInUp" data-wow-delay="0.5s" novalidate="true" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                        @csrf
                        <div class="row">
